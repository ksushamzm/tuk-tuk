...
export const categoriesData: Record<string, CategoryData> = {
  ...
  'спорт': {
    id: 'спорт',
    title: 'СПОРТ',
    starIcon: `${iconBase}Sport.png`,
    templateId: 3,
    blocks: [
      {
        id: 'sport',
        title: 'Какой вид спорта подойдёт именно Вам?',
        image: `${photoBase}Sport_3.jpg`,
        type: 'test'
      },
      {
        id: 'sport',
        title: 'ФУТБОЛ',
        text: 'Самый популярный вид спорта по количеству зрителей. Тайцы буквально одержимы Английской Премьер-лигой, особенно клубами «Ливерпуль» и «Манчестер Юнайтед»...',
        image: `${photoBase}Sport_1.jpg`,
        type: 'card'
      },
      {
        id: 'sport',
        title: 'Почему тайский бокс стал популярен по всему миру',
        type: 'info'
      },
      {
        id: 'sport',
        title: 'ВОЛЕЙБОЛ',
        text: 'Женская сборная Таиланда по волейболу — настоящие национальные героини. Их матчи смотрят целыми семьями, а популярность этого вида спорта среди молодежи за последние годы обогнала даже баскетбол.',
        type: 'card'
      },
      {
        id: 'sport',
        title: 'На сколько популярен спорт среди тайцев?',
        image: `${photoBase}Sport_2.jpg`,
        type: 'card'
      },
      {
        id: 'sport',
        title: 'Топ-5 самых популярных видов спорта в Таиланде',
        type: 'info'
      }
    ]
  },
  'танцы': {
    id: 'танцы',
    title: 'ТАНЦЫ',
    starIcon: `${iconBase}Dance.png`,
    templateId: 4,
    blocks: [
      {
        id: 'dance',
        title: 'Какой вид танцев подойдёт именно Вам?',
        image: `${photoBase}Dance_3.jpg`,
        type: 'test'
      },
      {
        id: 'dance',
        title: 'КХОН',
        text: 'Самый статусный жанр, включенный в список ЮНЕСКО. Это танцевальная драма в масках по мотивам эпоса «Рамакиян». Раньше его исполняли только для короля. Акценты здесь — на сложной пластике рук и роскошных костюмах.',
        image: `${photoBase}Dance_1.jpg`,
        type: 'card'
      },
      {
        id: 'dance',
      ...
      },
      {
        id: 'dance',
        title: 'ЛАКОН',
        text: 'Более плавный и женственный танец. В отличие от Кхона, здесь редко используют маски, а основной упор идет на мимику и изящные движения пальцев.',
        type: 'card'
      },
      {
        id: 'dance',
        title: 'На сколько популярны танцы в Таиланде?',
        image: `${photoBase}Dance_2.jpg`,
        type: 'card'
      },
      {
        id: 'dance',
        title: 'Топ-5 самых популярных видов танцев в Таиланде',
        type: 'info'
      }
    ]
  },
  'украшения': {
    id: 'украшения',
    title: 'УКРАШЕНИЯ',
    starIcon: `${iconBase}Jewelry.png`,
    templateId: 2,
    blocks: [
      {
        id: 'jewelry',
        title: 'На сколько хорошо Вы знаете названия украшений?',
        image: `${photoBase}Jewelry_1.jpg`,
        type: 'test'
      },
      {
        id: 'jewelry',
        title: 'ЗНАЧЕНИЯ УКРАШЕНИЙ В КУЛЬТУРЕ',
        text: 'Тайские украшения — это огромный пласт культуры, варьирующийся от высокопробного «желтого» золота до уникального серебра северных племен. В 2026 году Таиланд остается одним из мировых центров...',
        image: `${photoBase}Jewelry_2.jpg`,
        type: 'card'
      },
      {
        id: 'jewelry',
        title: 'На какие украшения стоит обратить внимание',
        type: 'info'
      },
      {
        id: 'jewelry',
        title: 'ДРАГОЦЕННЫЕ КАМНИ',
        text: 'Страна славится добычей и огранкой сапфиров и рубинов (центры в Чантабури и Канчанабури), а также добычей гранатов, шпинели и цирконов.',
        type: 'card'
      },
      {
        id: 'jewelry',
        title: 'Главные элементы украшений в Таиланде',
        image: `${photoBase}Jewelry_3.jpg`,
        type: 'card'
      },
      {
        id: 'jewelry',
        title: 'Топ-5 украшений в тайской культуре',
        type: 'info'
      }
    ]
  },
  'утварь и посуда': {
    id: 'утварь и посуда',
    title: 'УТВАРЬ И ПОСУДА',
    starIcon: `${iconBase}Utensils.png`,
    templateId: 1,
    blocks: [
      {
        id: 'utensils',
        title: 'Главные инструменты тайской кухни',
        image: `${photoBase}Utensils_1.jpg`,
        type: 'card'
      },
      {
        id: 'utensils',
        title: 'Особенности устройства тайской кухни',
        type: 'info'
      },
      {
        id: 'utensils',
        title: 'На сколько хорошо Вы знаете названия предметов утвари?',
        image: `${photoBase}Utensils_2.jpg`,
        type: 'test'
      },
      {
        id: 'utensils',
        title: 'СТУПКА И ПЕСТИК',
        text: 'Кхрок сак – главный инструмент тайской кухни. Гранитные ступки используются для измельчения твердых специй и приготовления паст карри...',
        image: `${photoBase}Utensils_3.jpg`,
        type: 'card'
      },
      {
        id: 'utensils',
        title: 'Традиционные и современные предметы кухни',
        type: 'info'
      },
      {
        id: 'utensils',
        title: 'НОЖ-ТОПОРИК',
        text: 'Универсальный тяжелый нож, который используется и для рубки костей, и для тонкой нарезки зелени...',
        type: 'card'
      }
    ]
  },
  'одежда': {
    id: 'одежда',
    title: 'ОДЕЖДА',
    starIcon: `${iconBase}Clothes.png`,
    templateId: 1,
    blocks: [
      {
        id: 'clothes',
        title: 'Самые популярные традиционные тайские наряды',
        image: `${photoBase}Clothes_1.jpg`,
        type: 'card'
      },
      {
        id: 'clothes',
        title: 'Как выбрать тайский наряд? Гайд от блогера @MyThai',
        type: 'info'
      },
      {
        id: 'clothes',
        title: 'Какого цвета тайский наряд подойдёт именно Вам?',
        image: `${photoBase}Clothes_2.jpg`,
        type: 'test'
      },
      {
        id: 'clothes',
        title: 'ТАЙСКОЕ ПЛАТЬЕ',
        text: 'Тайские платья, известные своим уникальным стилем и яркими цветами, представляют собой неотъемлемую часть культуры Таиланда. Одним из самых известных видов традиционной одежды является «чанг» — платье...',
        image: `${photoBase}Clothes_3.jpg`,
        type: 'card'
      },
      {
        id: 'clothes',
        title: 'Почему тайские наряды украшены золотом?',
        type: 'info'
      },
      {
        id: 'clothes',
        title: 'СВАДЕБНЫЕ НАРЯДЫ ТАИЛАНДА',
        text: 'Свадебные наряды в Таиланде отличаются яркостью, богатством деталей и глубоким уважением к традициям. Тайская свадьба — это не только важное событие для молодоженов, но и значимое мероприятие...',
        type: 'card'
      }
    ]
  },
  'орнаменты': {
    id: 'орнаменты',
    title: 'ОРНАМЕНТЫ',
    starIcon: `${iconBase}Ornaments.png`,
    templateId: 3,
    blocks: [
      {
        id: 'ornaments',
        title: 'Какой орнамент подойдет Вам?',
        image: `${photoBase}Ornaments_2.jpg`,
        type: 'test'
      },
      {
        id: 'ornaments',
        title: 'ЛАЙ ТАЙ',
        text: 'Традиционные тайские орнаменты, известные как Лай Тай (Lai Thai), представляют собой сложные переплетения линий, вдохновленные природой, буддизмом и индуистской мифологией. Основу стиля составляют...',
        image: `${photoBase}Ornaments_1.jpg`,
        type: 'card'
      },
      {
        id: 'ornaments',
      ...
      },
      {
        id: 'ornaments',
        title: 'КАНОК',
        text: 'Самая узнаваемая категория, имитирующая форму пламени, листьев лотоса или капель воды. Символизирует чистоту и мудрость...',
        type: 'card'
      },
      {
        id: 'ornaments',
        title: 'Все виды традиционных орнаментов Таиланда',
        image: `${photoBase}Ornaments_3.jpg`,
        type: 'card'
      },
      {
        id: 'ornaments',
        title: 'Топ-5 самых популярных тайских орнаментов',
        type: 'info'
      }
    ]
  },
  'праздники': {
    id: 'праздники',
    title: 'ПРАЗДНИКИ',
    starIcon: `${iconBase}Holidays.png`,
    templateId: 4,
    blocks: [
      {
        id: 'holidays',
        title: 'Какой вы тайский праздник?',
        image: `${photoBase}Holidays_3.jpg`,
        type: 'test'
      },
      {
        id: 'holidays',
        title: 'СОНГКРАН',
        text: 'Тайский Новый год: 13–15 апреля. Самый известный праздник, сопровождающийся массовыми обливаниями водой...',
        image: `${photoBase}Holidays_1.jpg`,
        type: 'card'
      },
      {
        id: 'holidays',
      ...
      },
      {
        id: 'holidays',
        title: 'ЛОЙ КРАТОНГ',
        text: 'Один из самых красивых и романтичных фестивалей Таиланда, который называют «Праздником света»...',
        type: 'card'
      },
      {
        id: 'holidays',
        title: 'Самые главные праздники в Таиланде',
        image: `${photoBase}Holidays_2.jpg`,
        type: 'card'
      },
      {
        id: 'holidays',
        title: 'На какой праздник Вам обязательно стоит попасть',
        type: 'info'
      }
    ]
  },
    ...
    blocks: [
      {
        ...
        image: `${photoBase}Religion_1.jpg`,
        type: 'card'
      },
      {
        id: 'religion',
        title: 'Почему основное мировоззрение в Таиланде именно буддизм?',
        type: 'info'
      },
      {
        id: 'religion',
        title: 'Как хорошо Вы знаете религии Таиланда?',
        image: `${photoBase}Religion_2.jpg`,
        type: 'test'
      },
      {
        id: 'religion',
        title: 'ХРИСТИАНСТВО',
        text: 'Христианство в Таиланде — это религия меньшинства, которую исповедуют около 1–1.4% населения. Несмотря на малую численность, христиане играют заметную роль в сферах образования и медицины страны...',
        image: `${photoBase}Religion_3.jpg`,
        type: 'card'
      },
      {
        id: 'religion',
        title: 'Влияние буддизма на экономику страны',
        type: 'info'
      },
      {
        id: 'religion',
        title: 'ИСЛАМ',
        text: 'Ислам является второй по численности религией в Таиланде, которую исповедуют от 5% до 12% населения, по разным оценкам, от 3.5 до 7.5 млн человек...',
        type: 'card'
      }
    ]
  },
  'рынки': {
    id: 'рынки',
    title: 'РЫНКИ',
    starIcon: `${iconBase}Markets.png`,
    templateId: 2,
    blocks: [
      {
        id: 'markets',
        title: 'Сможете ли вы торговаться на тайском рынке?',
        image: `${photoBase}Markets_1.jpg`,
        type: 'test'
      },
      {
        id: 'markets',
        title: 'УЛИЧНАЯ ЕДА',
        text: 'Правительство активно поддерживает имидж страны как «кухни мира», поэтому даже на рынках сейчас активно внедряются стандарты гигиены и безналичная оплата...',
        image: `${photoBase}Markets_2.jpg`,
        type: 'card'
      },
      {
        id: 'markets',
        title: 'Топ-5 самых популярных рынков Таиланда',
        type: 'info'
      },
      {
        id: 'markets',
        title: 'КУЛЬТУРА РЫНКОВ',
        text: 'Уличные рынки Таиланда — это центр общественной жизни, где можно найти всё: от экзотической уличной еды до винтажных вещей. В 2026 году инфраструктура рынков обновилась...',
        type: 'card'
      },
      {
        id: 'markets',
        title: 'Почему рынки в Таиланде так популярны и распространены?',
        image: `${photoBase}Markets_3.jpg`,
        type: 'card'
      },
      {
        id: 'markets',
        title: 'Всё что нужно знать, прежде чем пойти на тайский рынок',
        type: 'info'
      }
    ]
  },
  'фестивали': {
    id: 'фестивали',
    title: 'ФЕСТИВАЛИ',
    starIcon: `${iconBase}Festivals.png`,
    templateId: 3,
    blocks: [
      {
        id: 'festivals',
        title: 'Какой фестиваль подойдёт именно Вам?',
        image: `${photoBase}Festivals_2.jpg`,
        type: 'test'
      },
      {
        id: 'festivals',
        title: 'ФЕСТИВАЛЬ ЦВЕТОВ В ЧИАНГМАЕ',
        text: 'Время парадов огромных платформ, полностью сделанных из живых хризантем и далий. Весь город превращается в сад...',
        image: `${photoBase}Festivals_1.jpg`,
        type: 'card'
      },
      {
        id: 'festivals',
        title: 'На фестивали в Таиланде стоит обратить внимание',
        type: 'info'
      },
      {
        id: 'festivals',
        title: 'ВЕГАНСКИЙ ФЕСТИВАЛЬ НА ПХУКЕТЕ',
        text: 'Не путать с мирным обедом. Это время шокирующих ритуалов самоистязания и красочных шествий «ма-сонг» (медиумов). Сопровождается взрывами петард и строгой диетой...',
        type: 'card'
      },
      {
        id: 'festivals',
        title: 'Популярные фестивали в Таиланде',
        image: `${photoBase}Festivals_3.jpg`,
        type: 'card'
      },
      {
        id: 'festivals',
        title: 'Топ-5 фестивалей, которые стоит посетить',
        type: 'info'
      }
    ]
  },
  'хозяйство': {
    id: 'хозяйство',
    title: 'ХОЗЯЙСТВО',
    starIcon: `${iconBase}Economy.png`,
    templateId: 2,
    blocks: [
      {
        id: 'economy',
        title: 'Как хорошо Вы знаете тайское хозяйство?',
        image: `${photoBase}Economy_1.jpg`,
        type: 'test'
      },
      {
        id: 'economy',
        title: 'ТРОПИЧЕСКИЕ ГИГАНТЫ',
        text: 'Страна — мировой лидер по производству натурального каучука (из сока гевеи) и один из главных поставщиков пальмового масла, сахарного тростника и ананасов...',
        image: `${photoBase}Economy_2.jpg`,
        type: 'card'
      },
      {
        id: 'economy',
        title: 'Король фруктов: экспорт дуриана',
        type: 'info'
      },
      {
        id: 'economy',
        title: 'МОРЕПРОДУКТЫ',
        text: 'Тайские фермы по разведению креветок — одни из самых технологических в Азии. Сиамский залив и Андаманское море обеспечивают страну тунцом и рыбой...',
        type: 'card'
      },
      {
        id: 'economy',
        title: 'Всё что нужно знать о тайском хозяйстве',
        image: `${photoBase}Economy_3.jpg`,
        type: 'card'
      },
      {
        id: 'economy',
        title: 'Почему рис называют золотом страны?',
        type: 'info'
      }
    ]
  },
  'церемонии': {
    id: 'церемонии',
    title: 'ЦЕРЕМОНИИ',
    starIcon: `${iconBase}Ceremonies.png`,
    templateId: 3,
    blocks: [
      {
        id: 'ceremonies',
        title: 'Как хорошо Вы знаете тайские церемонии?',
        image: `${photoBase}Ceremonies_2.jpg`,
        type: 'test'
      },
      {
        id: 'ceremonies',
        title: 'КОРОЛЕВСКАЯ ЦЕРЕМОНИЯ ПАХОТЫ',
        text: 'Проходит на площади Санам Луанг в Бангкоке. Священные волы выбирают подношения (рис, кукурузу, воду), по которым астрологи предсказывают урожайность года.',
        image: `${photoBase}Ceremonies_1.jpg`,
        type: 'card'
      },
      {
        id: 'ceremonies',
        title: 'Семейные и жизненные ритуалы',
        type: 'info'
      },
      {
        id: 'ceremonies',
        title: 'СМЕНА ОДЕЯНИЙ ИЗУМРУДНОГО БУДДЫ',
        text: 'Лично Король трижды в год (в начале жаркого, дождливого и холодного сезонов) переодевает главную статую страны в золотые одежды...',
        type: 'card'
      },
      {
        id: 'ceremonies',
        title: 'Всё что нужно знать о тайских церемониях',
        image: `${photoBase}Ceremonies_3.jpg`,
        type: 'card'
      },
      {
        id: 'ceremonies',
        title: 'Самые популярные тайские церемонии',
        type: 'info'
      }
    ]
  },
  'чайные традиции': {
    id: 'чайные традиции',
    title: 'ЧАЙНЫЕ ТРАДИЦИИ',
    starIcon: `${iconBase}Tea.png`,
    templateId: 4,
    blocks: [
      {
        id: 'tea',
        title: 'Какой тайский чай подойдёт именно Вам?',
        image: `${photoBase}Tea_3.jpg`,
        type: 'test'
      },
      {
        id: 'tea',
        title: 'ТАЙСКИЙ «ОРАНЖЕВЫЙ» ЧАЙ',
        text: 'Самый узнаваемый символ страны. Это не просто напиток, а настоящий стрит-фуд десерт...',
        image: `${photoBase}Tea_1.jpg`,
        type: 'card'
      },
      {
        id: 'tea',
        title: 'Польза Синего чая Анчан',
        type: 'info'
      },
      {
        id: 'tea',
        title: 'ЧАЙНЫЕ ПЛАНТАЦИИ СЕВЕРА',
        text: 'На севере Таиланда (провинция Чианг Рай) живут потомки китайских солдат, которые привезли с собой культуру выращивания улунов...',
        type: 'card'
      },
      {
        id: 'tea',
        title: 'Всё что нужно знать о чайных традициях',
        image: `${photoBase}Tea_2.jpg`,
        type: 'card'
      },
      {
        id: 'tea',
        title: 'Самые популярные тайские чаи',
        type: 'info'
      }
    ]
  },
  'этика': {
    id: 'этика',
    title: 'ЭТИКА',
    starIcon: `${iconBase}Ethics.png`,
    templateId: 1,
    blocks: [
      {
        id: 'ethics',
        title: 'Всё что нужно знать о тайской этике',
        image: `${photoBase}Ethics_1.jpg`,
        type: 'card'
      },
      {
        id: 'ethics',
        title: 'Концепция «Лица»: что это значит и как это понимать',
        type: 'info'
      },
      {
        id: 'ethics',
        title: 'На сколько хорошо Вы знаете тайскую этику?',
        image: `${photoBase}Ethics_2.jpg`,
        type: 'test'
      },
      {
        id: 'ethics',
        title: 'КОНЦЕПЦИЯ «ЛИЦА»',
        text: 'Самое важное в тайском обществе — не потерять своё «лицо» и не заставить другого потерять его...',
        image: `${photoBase}Ethics_3.jpg`,
        type: 'card'
      },
      {
        id: 'ethics',
        title: 'Голова и ноги: как правильно вести себя среди тайцев',
        type: 'info'
      },
      {
        id: 'ethics',
        title: 'ИЕРАРХИЯ И ПРИВЕТСТВИЕ',
        text: 'Общество четко разделено на «старших» (Pi) и «младших» (Nong) по возрасту, социальному статусу или должности...',
        type: 'card'
      }
    ]
  },
  'философия': {
    id: 'философия',
    title: 'ФИЛОСОФИЯ',
    starIcon: `${iconBase}Philosophy.png`,
    templateId: 4,
    blocks: [
      {
        id: 'philosophy',
        title: 'На сколько Вам близка тайская философия?',
        image: `${photoBase}Philosophy_3.jpg`,
        type: 'test'
      },
      {
        id: 'philosophy',
        title: 'САНУК',
        text: 'Для тайца любое дело, даже работа, должно приносить удовольствие. Если в процессе нет «санука», таец быстро теряет к нему интерес. Это не лень, а стремление сделать жизнь эмоционально комфортной...',
        image: `${photoBase}Philosophy_1.jpg`,
        type: 'card'
      },
      {
        id: 'philosophy',
      ...
      },
      {
        id: 'philosophy',
        title: 'САБАЙ-САБАЙ',
        text: 'Это состояние высшего комфорта и расслабленности. «Сабай» означает «удобно». Тайцы избегают стресса, спешки и лишнего напряжения. Фраза «сабай-сабай» — это манифест жизни без суеты, когда всё идет своим чередом, и вы...',
        type: 'card'
      },
      {
        id: 'philosophy',
        title: 'Всё о философии жизни тайцев кратко',
        image: `${photoBase}Philosophy_2.jpg`,
        type: 'card'
      },
      {
        id: 'philosophy',
        title: 'Почему Вам стоит узнать больше о тайской философии',
        type: 'info'
      }
    ]
  },
  'храмы': {
    id: 'храмы',
    title: 'ХРАМЫ',
    starIcon: `${iconBase}Temples.png`,
    templateId: 1,
    blocks: [
      {
        id: 'temples',
        title: 'Почему храмы в Таиланде играют важную роль?',
        image: `${photoBase}Temples_1.jpg`,
        type: 'card'
      },
      {
        id: 'temples',
        title: '5 храмов которые Вам обязательно стоит посетить',
        type: 'info'
      },
      {
        id: 'temples',
        title: 'В какой храм стоит зайти именно Вам?',
        image: `${photoBase}Temples_2.jpg`,
        type: 'test'
      },
      {
        id: 'temples',
        title: 'ВАТЫ',
        text: 'Храмы (Ваты) — это сердце тайской культуры. В Таиланде насчитывается более 40 000 действующих буддийских храмов. В 2026 году они остаются не только религиозными центрами...',
        image: `${photoBase}Temples_3.jpg`,
        type: 'card'
      },
      {
        id: 'temples',
        title: 'Ват Пхра Кео: храм, который обязательно стоит увидеть',
        type: 'info'
      },
      {
        id: 'temples',
        title: 'ВАТ АРУН',
        text: 'Знаменитая высокая пагода (пранг) на берегу реки Чаопрайя, украшенная миллионами осколков китайского фарфора. В 2026 году это одно из самых популярных мест для фотосессий в традиционных тайских костюмах...',
        type: 'card'
      }
    ]
  },
  'юмор': {
    id: 'юмор',
    title: 'ЮМОР',
    starIcon: `${iconBase}Humor.png`,
    templateId: 3,
    blocks: [
      {
        id: 'humor',
        title: 'Сколько тайских шуток Вы поймёте?',
        image: `${photoBase}Humor_2.jpg`,
        type: 'test'
      },
      {
        id: 'humor',
        title: 'САМОИРОНИЯ И «ЛИЦО»',
        text: 'Несмотря на важность «сохранения лица», тайцы обожают смеяться над собой. Умение превратить свою ошибку в шутку — высший пилотаж философии Май Пэн Рай...',
        image: `${photoBase}Humor_1.jpg`,
        type: 'card'
      },
      {
        id: 'humor',
        title: 'Подборка самых смешных тайских шуток с объяснением',
        type: 'info'
      },
      {
        id: 'humor',
        title: 'ИГРА СЛОВ',
        text: 'Тайский язык тональный, поэтому замена одной интонации может превратить «собаку» в «лошадь» или что-то неприличное. На этом строятся тысячи каламбуров...',
        type: 'card'
      },
      {
        id: 'humor',
        title: 'Всё что нужно знать о тайском юморе',
        image: `${photoBase}Humor_3.jpg`,
        type: 'card'
      },
      {
        id: 'humor',
        title: 'Главные фишки тайского юмора',
        type: 'info'
      }
    ]
  },
  'язык': {
    id: 'язык',
    title: 'ЯЗЫК',
    starIcon: `${iconBase}Language.png`,
    templateId: 4,
    blocks: [
      {
        id: 'language',
        title: 'Сколько тайских букв Вы знаете?',
        image: `${photoBase}Language_3.jpg`,
        type: 'test'
      },
      {
        id: 'language',
        title: 'ТОНАЛЬНОСТЬ',
        text: 'Ровный, низкий, падающий, высокий и восходящий. Например, слово «май» в зависимости от тона может означать: новое, дерево, не (отрицание), гореть или вопросительную частицу...',
        image: `${photoBase}Language_1.jpg`,
        type: 'card'
      },
      {
        id: 'language',
      ...
      },
      {
        id: 'language',
        title: 'АЛФАВИТ',
        text: 'В нем 44 согласные и 32 гласные буквы. Тайское письмо — это абугида (слоговое письмо), где гласные могут писаться сверху, снизу, слева или справа от согласной...',
        type: 'card'
      },
      {
        id: 'language',
        title: 'Всё что нужно знать о тайском языке',
        image: `${photoBase}Language_2.jpg`,
        type: 'card'
      },
      {
        id: 'language',
        title: 'Рассказываем и показываем тайский алфавит',
        type: 'info'
      }
    ]
  },
  'ювелирное дело': {
    ...
    starIcon: `${iconBase}Jewelry%20Art.png`,
    templateId: 2,
    blocks: [
      {
        id: 'jewelry_art',
        title: 'Какое украшение подошло бы именно Вам?',
        image: `${photoBase}Jewelry%20Art_1.jpg`,
        type: 'test'
      },
      {
        id: 'jewelry_art',
        title: 'ЧАНТАБУРИ',
        text: 'Город на востоке страны, известный как «столица самоцветов». Здесь расположены крупнейшие рынки сырых камней, куда съезжаются дилеры со всего мира...',
        image: `${photoBase}Jewelry%20Art_2.jpg`,
        type: 'card'
      },
      {
        id: 'jewelry_art',
        title: 'Золотой стандарт тайского золота',
        type: 'info'
      },
      {
        id: 'jewelry_art',
        title: 'ОГРАНКА',
        text: 'Тайские мастера считаются одними из лучших в мире по искусству термической обработки (облагораживания) и симметричной огранке камней',
        type: 'card'
      },
      {
        id: 'jewelry_art',
        title: 'Всё что нужно знать о тайском ювелирном деле',
        image: `${photoBase}Jewelry%20Art_3.jpg`,
        type: 'card'
      },
      {
        id: 'jewelry_art',
        title: 'Центр драгоценных камней: самые популярные камни',
        type: 'info'
      }
    ]
  },
