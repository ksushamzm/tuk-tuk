    ...
    <div className="w-full bg-white flex flex-col">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 border-b-2 border-black">
         <Card 
            ...
            image={content?.['category_1_image'] || "https://picsum.photos/seed/tuk_tuk_v2/600/900"} 
            hasSticker={true}
         ...
         <Card 
            ...
            image={content?.['category_2_image'] || "https://picsum.photos/seed/buddha_gold/600/900"} 
            hasSticker={true}
         ...
         <Card 
            ...
            image={content?.['category_3_image'] || "https://picsum.photos/seed/thai_temple_roof/600/900"} 
            hasSticker={true}
