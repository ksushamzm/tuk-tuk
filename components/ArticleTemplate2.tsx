...
const ArticleTemplate2: React.FC<Props> = ({ data }) => {
  ...
  return (
    <div className="w-full bg-white font-roboto overflow-hidden">
      ...
      {/* Row 1: Section 1 (Text Aligned Right) */}
      <div className="flex flex-col relative bg-white">
        <div className="w-full flex justify-end">
          <div className="w-[85%] md:w-1/2 p-[14px] md:p-[3vw] bg-white pt-10 md:pt-[3vw]">
            <div className="text-[18px] md:text-[2.2vw] font-normal italic leading-[1.3] text-black max-w-[95%]">
              {data.blocks.section1Text?.map((p, i) => (
                <p key={i}>{fixHangingPrepositions(p)}</p>
              ))}
            </div>
          </div>
        </div>
      ...
      {/* Row 2: Section 2 (Title + Points) */}
      <div className="flex flex-col relative bg-white pb-10">
        <div className="w-[85%] md:w-[55%] p-[14px] md:p-[3vw] bg-white pt-6 md:pt-[2vw]">
        ...
        <div className="w-full flex justify-end">
          <div className="w-[85%] md:w-1/2 p-[14px] md:p-[3vw] bg-white pt-0 md:pt-0">
            <div className="text-[18px] md:text-[2.2vw] font-normal italic leading-[1.3] text-black max-w-[95%]">
      ...
      {/* Row 3: Photo Strip (Proportions specified) */}
